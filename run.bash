...
if [[ $ZONE == "europe-west4-"* ]]; then
    DEST_DIR="$TPU_VM_NAME:/nfs/nfs3/users/$USER/bigvision_cot"
elif [[ $ZONE == "us-central2-"* ]]; then
    DEST_DIR="$TPU_VM_NAME:/nfs/nfs2/users/$USER/bigvision_cot"
else
...
rsync -avzL --exclude .git --exclude-from=.gitignore . $DEST_DIR || exit 1
