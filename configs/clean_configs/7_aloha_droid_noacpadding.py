...
MAX_ACTION_DIM = 14
MAX_CHUNK_SIZE = 15 # change aloha chunk size to 15 and see if same issue happens ... if it doesn't then this is a chunking issue!
...
PROPRIO_KEYS = ["franka", "bimanual"] # in the order you want them to appear in the sequence

DATA_MIX = "franka_aloha_mix"
USE_ACTIONS_DCT = {
...
VISUALIZATIONS = {
    "aloha_pick_place_full_dataset": ['sanity_print'],
    "droid_dataset": ['sanity_print'],
}
