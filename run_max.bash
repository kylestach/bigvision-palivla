...
if [ $# -eq 0 ]; then
    echo "Usage: $0 <tpu-vm-name> <tpu-ip>"
    exit 1
fi
...
DEST_DIR="$TPU_IP:/nfs/aidm_nfs/max/big_vision"
...
rsync -avzL -e "ssh -i ~/.ssh/google_compute_engine" --exclude .git --exclude-from=.gitignore . $DEST_DIR
